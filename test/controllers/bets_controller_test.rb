...
class BetsControllerTest < ActionController::TestCase
  ...
  test "should create bet" do
    assert_difference('Bet.count') do
      post :create, bet: { against_user: @bet.against_user, description: @bet.description, init_user: @bet.init_user, value: @bet.value, winner: @bet.winner }
    end
  ...
  test "should update bet" do
    patch :update, id: @bet, bet: { against_user: @bet.against_user, description: @bet.description, init_user: @bet.init_user, value: @bet.value, winner: @bet.winner }
    assert_redirected_to bet_path(assigns(:bet))
  end
